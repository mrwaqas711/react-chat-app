            ...
            <div className="absolute inset-0 bg-black min-h-screen ">
                <div className="p-8 grid gap-4 bg-black">
                    <div>
                        ...
                        <button onClick={() => setShowAllPhotos(false)} className="fixed right-8 top-8 flex gap-1 items-center py-2 px-3 rounded-2xl shadow shadow-black bg-white text-black">
                    ...
                    {place?.photos?.length > 0 && place.photos.map(photo => (
                        <div>
                            <img src={'http://localhost:4000/uploads/' + photo} alt={photo.title} />
                        </div>
                    ))}
                </div>
            </div>
